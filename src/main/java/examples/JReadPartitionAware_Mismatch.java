...
public class JReadPartitionAware_Mismatch extends Helper {
  @Override
  ...
  protected void otherTests(Dataset<Row> data) {
    ...
    public static void main(String[] args) throws Exception {
        JReadPartitionAware_Mismatch mismatch = new JReadPartitionAware_Mismatch();
        mismatch.test("JReadPartitionAware-Mismatch", "datasources.PartitioningRowDataSource");
    }
}